const containers = document.querySelector('.containers .containers__inner');
...
async function Containers() {
                    ...
                    for (let color of colors) {
                        colorsBlocks += `
                            <a class="containers__card-colors-item" data-color="assets/img/containers/${color.img}">
                                <img src="assets/img/colors/${color.color}.svg" alt="">
                            </a>
                        `;
                    }
                }
                            ...
                            imgBlocks += `
                               <a href="assets/img/containers/${i.img}.jpg">
                                    <picture>
                                        ...
                                        <img class="watermark" src="assets/img/containers/${i.img}.jpg" alt="">
                                    </picture>
                               </a>
                            `;
                        }
                        ...
                        for (let i of img) {
                            imgBlocks += `
                                <a href="assets/img/sertificates/${i.img}">
                                    <img class="watermark" src="assets/img/sertificates/${i.img}" alt="">
                                </a>
                            `;
                        }
                    }
                        ...
                        <div class="containers__card-img">
                            <a href="#details_popup${c.popupId}" class="popup-link">
                                <picture>
                                    ...
                                    <img class="watermark" src="assets/img/containers/${c.img}.jpg" alt="">
                                </picture>
                            </a>
                        </div>
    ...
    const imgForColors = document.querySelectorAll('.containers__card-colors-item');

    if (imgForColors.length > 0) {
        for (let index = 0; index < imgForColors.length; index++) {
            const imgForColor = imgForColors[index];
            imgForColor.addEventListener('click', function (e) {
                const img = imgForColor.getAttribute('data-color');
