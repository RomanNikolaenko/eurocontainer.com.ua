let clients = document.querySelector('.clients .clients__items');
let reviews = document.querySelector('.reviews .reviews__items');
let regions = document.querySelector('.regions .regions__items');

// let popupReviews = document.querySelector('.reviews');
    ...
    return `
          <div class="clients__item">
              <picture>
                  ...
                  <img src="assets/img/clients/${item.img}.jpg" class="clients__img" width="142" height="92" alt="">
              </picture>
          ...
          <div class="reviews__item">
              <a href="assets/img/reviews/${item.img}">
                ...
                <picture>
                    ...
                    <img src="assets/img/reviews/${item.img}" class="reviews__img watermark" width="174" height="330" alt="">
                </picture>
              </a>
          </div>
      `;
    ...
    return `
        <div class="regions__item">
          ...
          <picture>
              ...
              <img src="assets/img/regions/${item.img}.png" class="clients__img" width="174" height="174" alt="">
          </picture>
...
// scroll_up
let ofs = 100; // offset если уже проскролено на 100, то кнопка должна проявиться
...
if (links.length > 0) {
  for (let index = 0; index < links.length; index++) {
    ...
    link.addEventListener('click', function (e) {
      let linkName = link.getAttribute('href').replace('#', '');
      let scrollTo = document.getElementById(linkName);
      scrolling(scrollTo);
      e.preventDefault();
